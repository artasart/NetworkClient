...
namespace RenderHeads.Media.AVProVideo.Demos
{
	public class MediaPlayerUI : MonoBehaviour
	{
		...
		/// <summary>
		/// 상대방 컨트롤 비활성화 하기 위해 추가 BKK
		/// </summary>
		/// <param name="enable"></param>
		public void SetInteractable(bool enable)
		{
			_controlsGroup.interactable = enable;
			_controlsGroup.blocksRaycasts = enable;
			_videoTouch.GetComponent<MaskableGraphic>().raycastTarget = enable;
		}
